import time
from functions import count_csv_rows,count_csv_rows_dask, get_column_names, get_unique_values_by_column, display_top_rows

file_path = 'test_data/2018_Yellow_Taxi_Trip_Data.csv'
...
# print(f"Total rows (Pandas): {rows_pandas}")
